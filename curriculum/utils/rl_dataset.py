    ...
    def _load_good_examples(self, top_n: int = 3) -> List[Dict[str, str]]:
        ...
        try:
            ...
            if self._last_files_state == current_state:
                print(f"😊😊😊 Using cached good examples (state unchanged)")
            ...
            print(f"😊😊😊 Reloaded {len(good_examples)} good examples from changed files")
            # Update cache
            ...
            print(f"⚠️ Error loading good examples: {e}")
            return []
